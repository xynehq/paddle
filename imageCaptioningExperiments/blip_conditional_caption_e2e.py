"""
End-to-End BLIP Conditional Image Captioning with Text Prompts
This script processes PDFs, extracts images and text, then generates captions using BLIP with text prompts.
"""
import base64
import json
import requests
...
IMAGES_DIR = pathlib.Path("downloads/imagesBLIP")
OUTPUT_CSV = "blip_conditional_captions.csv"
